...
export default function CreateTaxRecord() {
    ...
    async function handleSubmit(event) {
        ...
        if (!TaxRecord.name) {
            ...
            try {
                ...
                const response = await fetch("http://127.0.0.1:8000/tax_records/", {
                    method: 'POST',
                    body: formData,
                    headers: {
                ...
                if(response.ok){
                    ...
                    alert('Unable to create Tax Record')
                )
            }
            catch(error) {
        ...
        <div className="container my-4">
            <div className="row">
                <div className='col-md-8 mx-auto rounded border p-4'>
                    <h2 className= "text-center mb-5">Create Tax Record</h2>
